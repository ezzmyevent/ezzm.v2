					...
					<form id="activity_details" method="post" enctype="multipart/form-data">
						<div class="login_form_selection">
							...
							<div class="row justify-content-center">
								<h3>Yes </h3>
								<p>Attendees to be directed to Fields Page</p>
											...
											<table class="table table-sm table-borderless mb-3">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<h6 class="text-primary">Name of Guest :</h6>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td>
															<select class="form-select" name="adult_1">
																	...
																	<option value="Sibling" <?= $user_details->adult_1 == 'Sibling' ? 'selected':''; ?>>Sibling</option>
																	<option value="Son/Daughter 16+" <?= $user_details->adult_1 == 'Son/Daughter 16+' ? 'selected':''; ?>>Son/Daughter 16+</option>
																	<option value="No" <?= !in_array($user_details->adult_1, ['Father', 'Mother','Spouse',
																	 'Father-in-law', 'Mother-in-law','Sibling','Son/Daughter 16+']) ? 'selected':''; ?>>No</option>
                                                            </select>
														</td>
														<td><input type="text" class="form-control" name="guest1_name" value="{{$user_details != null ? $user_details->guest1_name:''}}" placeholder="Enter guest 1 name"></td>
													</tr>
													<tr>
														<td>
															Adult 2
														...
														<td>
															<select class="form-select" name="adult_2">
																...
																<option value="Sibling" <?= $user_details->adult_2 == 'Sibling' ? 'selected':''; ?>>Sibling</option>
																<option value="Son/Daughter 16+" <?= $user_details->adult_2 == 'Son/Daughter 16+' ? 'selected':''; ?>>Son/Daughter 16+</option>
																<option value="No" <?= !in_array($user_details->adult_2, ['Father', 'Mother','Spouse', 
																'Father-in-law', 'Mother-in-law','Sibling','Son / Daughter 16+']) ? 'selected':''; ?>>No</option>
															</select>
														</td>
														<td><input type="text" class="form-control" name="guest2_name" value="{{$user_details != null ? $user_details->guest2_name:''}}" placeholder="Enter guest 2 name"></td>
													</tr>
													<tr>
														<td>
															Adult 3
														...
														<td>
														    ...
														    <select class="form-select" name="spouse">
																...
																<option value="Sibling" <?= $user_details->spouse == 'Sibling' ? 'selected':''; ?>>Sibling</option>
																<option value="Son / Daughter 16+" <?= $user_details->spouse == 'Son / Daughter 16+' ? 'selected':''; ?>>Son / Daughter 16+</option>
																<option value="NO" <?= !in_array($user_details->spouse, ['Father', 'Mother','Spouse', 
																'Father-in-law', 'Mother-in-law','Sibling','Son / Daughter 16+']) ? 'selected':''; ?>>NO</option>
                                                            </select>
														</td>
														<td><input type="text" class="form-control" name="guest3_name" value="{{$user_details != null ? $user_details->guest3_name:''}}" placeholder="Enter guest 3 name"></td>
													...
													<tr>
														...
														<td>
															<select class="form-select" name="kid_1">
																<option value="8-15" <?= $user_details->kid_1 == '0-8' ? 'selected':''; ?>>8-15</option>
																<!-- <option value="8+" <?= $user_details->kid_1 == '8+' ? 'selected':''; ?>>8+</option> -->
													...
													<tr>
														...
														<td>
															<select class="form-select" name="kid_2">
																<option value="0-8" <?= $user_details->kid_2 == '0-8' ? 'selected':''; ?>>0-8</option>
																<!-- <option value="8+" <?= $user_details->kid_2 == '8+' ? 'selected':''; ?>>8+</option> -->
							...
							@if($user_details->details_updated==0)
							<div class="col-sm-12 col-md-12 text-center" id="remove_submit">
								<button class="btn btn-primary px-3 submit-btn submitbtn1" data-type="Submit"
							...
							<div class="col-sm-12 col-md-12 text-center">
								<button class="btn btn-primary submit-btn px-3" type="button">
								Update
								</button>
							</div>
							@endif
