<div class="modal-content">
    ...
    <!-- Modal body -->
  <form id="importdetailsnew" method="post" enctype="multipart/form-data">
      @csrf
      ...
      <div class="modal-footer">
          <button type="button" class="btn btn-main btn-full submit-btn-for-import-new">Upload</button>
