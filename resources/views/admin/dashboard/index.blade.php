	...
	<div class="row dashboard-stat-outer dso-top">
		<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="dashboard-stat2">
                <div class="display">
                    ...
                    <div class="number">
                        <small class="crd-heding">Pre Registered Users</small>
                        <h3 class="">{{ isset($user_count_data['online'])?$user_count_data['online']:0 }}</h3>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="dashboard-stat2">
                <div class="display">
                    <div class="icon">
                      {{--  <img class="" src="{{ asset('public/admin/assets/images/ticket_sales.svg')}}">--}}
                        <img class="" src="{{ asset('public/admin/assets/images/tickets_icon.svg')}}">
                    </div>
                    <div class="number">
                        <small class="crd-heding">Onspot Registered User</small>
                        <h3 class="">{{ isset($user_count_data['onsite'])?$user_count_data['onsite']:0 }}</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="number">
                        ...
                        <div class="stat-double">
                            <div class="stat-double-left">
                                ...
                                <h3 class="">{{ isset($redeem_count_data['online'])?$redeem_count_data['online']:0 }}</h3>
                            </div>
                            <div class="stat-double-right">
                                <div class="stat-free">Onspot</div>
                                <h3 class="">{{ isset($redeem_count_data['onsite'])?$redeem_count_data['onsite']:0 }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="number">
                            ...
                            <div class="stat-double">
                                <div class="stat-double-left">
                                    ...
                                    <h3 class="">{{ isset($category['online'])?$category['online']:0 }}</h3>
                                </div>
                                <div class="stat-double-right">
                                    <div class="stat-free">Onspot</div>
                                    <h3 class="">{{ isset($category['onsite'])?$category['onsite']:0 }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="progress-circle card blue-circle">
                    ...
                    <div class="tecket-detail">
                        ...
                        <p class="text-light reg-14">{{ isset($online_count)?$online_count:0  }}</p>
                ...
                <div class="col-lg-6 space-left">
                    ...
                    <div class="progress-circle card red-circle">
                        ...
                        <div class="tecket-detail">
                            ...
                            <p class="text-light reg-14">{{ isset($onsite_count)?$onsite_count:0  }}</p>
