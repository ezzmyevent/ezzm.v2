        ...
        <div class="row dashboard-stat-outer dso-top">
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        ...
                        <div class="number">
                            <small class="crd-heding">Total Registered Users</small>
                            <h3 class="">
                                {{--<a href="exportUsersAll">--}}
                                {{ (isset($user_count_data['online']) ? $user_count_data['online'] : 0) + (isset($user_count_data['onsite']) ? $user_count_data['onsite'] : 0) }}
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        ...
                        <div class="number">
                            <small class="crd-heding">Online Registered Users</small>
                            <h3 class="">
                                {{--<a href="exportUsersAll">--}}
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        ...
                        <div class="number">
                            <small class="crd-heding">Onsite Registered Users</small>
                            <h3 class="">
                                <a href="exportonsiteuser">
                    ...
                    <div class="display">
                        ...
                        <div class="number">
                            ...
                            <h3 class="">
                                    ...
                                    <a href="exportUsers">{{ $successCount ?? 0 }}</a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        ...
                        <div class="number">
                            <small class="crd-heding">Zapping</small>
                            <h3 class="">
                                
                                    <a href="exportZappingUsers">{{$zappingCount ?? 0}}</a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        ...
                        <div class="number">
                            <small class="crd-heding">Attendees Yes</small>
                            <h3 class="">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        ...
                        <div class="number">
                            <small class="crd-heding">Attendees No</small>
                            <h3 class="">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        ...
                        <div class="number">
                            <small class="crd-heding">Self Redemption</small>
                            <h3 class="">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        ...
                        <div class="number">
                            <small class="crd-heding">Total Redemption</small>
                            <h3 class="">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        ...
                        <div class="number">
                            <small class="crd-heding">Total  Kids Redemption</small>
                            <h3 class="">{{$kidisprintgift ?? 0}}
            ...
            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2 stat-multiple">
                    <div class="display">
                        <div class="number">
                            <small class="crd-heding">Online Users</small>
                            <div class="stat-double">
                                <div class="stat-double-left">
                                    <div class="stat-free">No Of Spouse</div>
                                    <h3 class="">
                                    {{ isset($spouse['online'])?$spouse['online']:0 }}
                                    
                                    </h3>
                                </div>
                                <div class="stat-double-left">
                                    <div class="stat-free">No Of Father</div>
                                    <h3 class="">
                                    {{ isset($father['online'])?$father['online']:0 }}
                                    </h3>
                                </div><div class="stat-double-left">
                                    <div class="stat-free">No Of Mother</div>
                                    <h3 class="">
                                    {{ isset($mother['online'])?$mother['online']:0 }}

                                    </h3>
                                </div>
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of Father In Law</div>
                                    <h3 class="">
                                    {{ isset($fatherinlaw['online'])?$fatherinlaw['online']:0 }}
                                    </h3>
                                </div>

                                <div class="stat-double-right">
                                    <div class="stat-free">No Of Mother In Law</div>
                                    <h3 class="">
                                    {{ isset($motherinlaw['online'])?$motherinlaw['online']:0 }}
                                    </h3>
                                </div>

                                <div class="stat-double-right">
                                    <div class="stat-free">No Of 0-6</div>
                                    <h3 class="">
                                    {{ isset($kid_0_6['online'])?$kid_0_6['online']:0 }}
                                    </h3>
                                </div>

                                <div class="stat-double-right">
                                    <div class="stat-free">No Of 7-12</div>
                                    <h3 class="">
                                    {{ isset($kid_7_12['online'])?$kid_7_12['online']:0 }}

                                    </h3>
                                </div>

                                <div class="stat-double-right">
                                    <div class="stat-free">No Of 13-18</div>
                                    <h3 class="">
                                    {{ isset($kid_13_18['online'])?$kid_13_18['online']:0 }}
                                    </h3>
                                </div>
            ...
            <!-- <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2 stat-multiple">
                    <div class="display">
                        <div class="number">
                            <small class="crd-heding">Onspot Users</small>
                            <div class="stat-double">
                                <div class="stat-double-left">
                                    <div class="stat-free">No Of Spouse</div>
                                    <h3 class="">
                                    {{ isset($spouse['onsite'])?$spouse['onsite']:0 }}
                                    </h3>
                                </div>
                                <div class="stat-double-left">
                                    <div class="stat-free">No Of Father</div>
                                    <h3 class="">
                                    {{ isset($father['onsite'])?$father['onsite']:0 }}
                                    </h3>
                                </div><div class="stat-double-left">
                                    <div class="stat-free">No Of Mother</div>
                                    <h3 class="">
                                    {{ isset($mother['onsite'])?$mother['onsite']:0 }}
                                    </h3>
                                </div>
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of Father In Law</div>
                                    <h3 class="">
                                    {{ isset($fatherinlaw['onsite'])?$fatherinlaw['onsite']:0 }}
                                    </h3>
                                </div>
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of Mother In Law</div>
                                    <h3 class="">
                                    {{ isset($motherinlaw['onsite'])?$motherinlaw['onsite']:0 }}
                                    </h3>
                                </div>
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of 0-6</div>
                                    <h3 class="">
                                    {{ isset($kid_0_6['onsite'])?$kid_0_6['onsite']:0 }}
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of 7-12</div>
                                    <h3 class="">
                                    {{ isset($kid_7_12['onsite'])?$kid_7_12['onsite']:0 }}
                                    </h3>
                                </div>
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of 13-18</div>
                                    <h3 class=""> 
                                        {{ isset($kid_13_18['onsite'])?$kid_13_18['onsite']:0 }}
                                    </h3>
                                </div>
            ...
            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2 stat-multiple">
                    <div class="display">
                        <div class="number">
                            <small class="crd-heding">Online Redemption Users</small>
                            <div class="stat-double">
                                <div class="stat-double-left">
                                    <div class="stat-free">No Of Spouse</div>
                                    <h3 class="">
                                    {{ isset($spouseCount['online'])?$spouseCount['online']:0 }}
                                    </h3>
                                </div>
                                <div class="stat-double-left">
                                    <div class="stat-free">No Of Father</div>
                                    <h3 class="">
                                    {{ isset($FatherCount['online'])?$FatherCount['online']:0 }}

                                    </h3>
                                </div><div class="stat-double-left">
                                    <div class="stat-free">No Of Mother</div>
                                    <h3 class="">
                                    {{ isset($MotherCount['online'])?$MotherCount['online']:0 }}
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of Father In Law</div>
                                    <h3 class="">
                                    {{ isset($FatherinlawCount['online'])?$FatherinlawCount['online']:0 }} 
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of Mother In Law</div>
                                    <h3 class="">
                                    {{ isset($MotherinlawCount['online'])?$MotherinlawCount['online']:0 }}
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of 0-6</div>
                                    <h3 class="">
                                    {{ isset($kidCount1['online'])?$kidCount1['online']:0 }}
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of 7-12</div>
                                    <h3 class="">
                                    {{ isset($kidCount2['online'])?$kidCount2['online']:0 }}
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of 13-18</div>
                                    <h3 class=""> 
                                    {{ isset($kidCount3['online'])?$kidCount3['online']:0 }}
            ...
            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2 stat-multiple">
                    <div class="display">
                        <div class="number">
                            <small class="crd-heding">Onspot Redemption Users</small>
                            <div class="stat-double">
                                <div class="stat-double-left">
                                    <div class="stat-free">No Of Spouse</div>
                                    <h3 class="">
                                    {{ isset($spouseCount['onsite'])?$spouseCount['onsite']:0 }}
                                    </h3>
                                </div>
                                <div class="stat-double-left">
                                    <div class="stat-free">No Of Father</div>
                                    <h3 class="">
                                    {{ isset($FatherCount['onsite'])?$FatherCount['onsite']:0 }}

                                    </h3>
                                </div><div class="stat-double-left">
                                    <div class="stat-free">No Of Mother</div>
                                    <h3 class="">
                                  {{ isset($MotherCount['onsite'])?$MotherCount['onsite']:0 }}
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of Father In Law</div>
                                    <h3 class="">
                                    {{ isset($FatherinlawCount['onsite'])?$FatherinlawCount['onsite']:0 }}
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of Mother In Law</div>
                                    <h3 class="">
                                   {{ isset($MotherinlawCount['onsite'])?$MotherinlawCount['onsite']:0 }}
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of 0-6</div>
                                    <h3 class="">
                                  {{ isset($kidCount1['onsite'])?$kidCount1['onsite']:0 }}
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of 7-12</div>
                                    <h3 class="">
                                   {{ isset($kidCount2['onsite'])?$kidCount2['onsite']:0 }}
                                ...
                                <div class="stat-double-right">
                                    <div class="stat-free">No Of 13-18</div>
                                    <h3 class=""> 
                                   {{ isset($kidCount3['onsite'])?$kidCount3['onsite']:0 }}
            ...
            <!-- <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2 stat-multiple">
                    <div class="display">
                        <div class="number">
                            <small class="crd-heding">Entry Users</small>
                            <div class="stat-double">
                                <div class="stat-double-left">
                                    <div class="stat-free">Employee</div>
                                    <h3 class="">
                                        <a href="exportUsersAll">{{ $mainUserCount ?? 0 }}</a>
                                        
                                    </h3>
                                </div>
                                <div class="stat-double-right">
                                    <div class="stat-free">Member</div>
                                    <h3 class="">
                                        {{ $memberCount ?? 0 }}
                                    </h3>
                                </div>
            ...
            <!-- <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="dashboard-stat2">
                    <div class="display">
                        ...
                        <div class="number">
                            <small class="crd-heding">Goodies</small>
                            <h3 class="">
                                
                                    <a href="onspotExportUsers">{{ $mainUserGoodieCount ?? 0 }}</a>
